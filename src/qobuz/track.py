from qobuz import Artist, Album
...
class Track(object):
    ...
    track_item: dict
        ...
        'track_number', 'performers', 'artist_name', 'maximum_format_id', 'favorited_at'
    """
    ...
    def __init__(self, track_item, album=None):
        ...
        self.favorited_at = track_item.get("favorited_at")
    ...
    @classmethod
    def from_id(cls, id):
        """Build Track from an id"""
        return cls(qobuz_api.api_call("track/get", track_id=id))
